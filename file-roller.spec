...
Source0  : https://download.gnome.org/sources/file-roller/3.40/file-roller-3.40.0.tar.xz
...
%prep
%setup -q -n file-roller-3.40.0
cd %{_builddir}/file-roller-3.40.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1620062028
...
cp %{_builddir}/file-roller-3.40.0/COPYING %{buildroot}/usr/share/package-licenses/file-roller/68c94ffc34f8ad2d7bfae3f5a6b996409211c1b1
