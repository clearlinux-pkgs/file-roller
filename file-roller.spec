...
Source0  : https://download.gnome.org/sources/file-roller/44/file-roller-44.tar.xz
...
%prep
%setup -q -n file-roller-44
cd %{_builddir}/file-roller-44
pushd ..
cp -a file-roller-44 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711377787
