...
Source0  : https://download.gnome.org/sources/file-roller/3.36/file-roller-3.36.2.tar.xz
...
%prep
%setup -q -n file-roller-3.36.2
cd %{_builddir}/file-roller-3.36.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1587507926
...
cp %{_builddir}/file-roller-3.36.2/COPYING %{buildroot}/usr/share/package-licenses/file-roller/68c94ffc34f8ad2d7bfae3f5a6b996409211c1b1
