...
%prep
%setup -q -n file-roller-3.32.3
cd %{_builddir}/file-roller-3.32.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1574699000
...
cp %{_builddir}/file-roller-3.32.3/COPYING %{buildroot}/usr/share/package-licenses/file-roller/68c94ffc34f8ad2d7bfae3f5a6b996409211c1b1
